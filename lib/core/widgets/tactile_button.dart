...
enum TactileButtonVariant { primary, gold, green, blue, purple, danger, muted, ghost }
...
class _TactileButtonState extends State<TactileButton> {
  ...
  Color get _baseColor {
    ...
    switch (widget.variant) {
      ...
      case TactileButtonVariant.blue:     return const Color(0xFF4A7FC1);
      case TactileButtonVariant.purple:   return const Color(0xFF9060C8);
  ...
  bool get _isGoldVariant => widget.variant == TactileButtonVariant.gold || widget.variant == TactileButtonVariant.green || widget.variant == TactileButtonVariant.blue || widget.variant == TactileButtonVariant.purple;
          ...
          decoration: BoxDecoration(
            ...
            gradient: widget.variant == TactileButtonVariant.gold
                ...
                : widget.variant == TactileButtonVariant.green
                    ...
                    : widget.variant == TactileButtonVariant.blue
                        ? const LinearGradient(
                            begin: Alignment.topCenter,
                            end: Alignment.bottomCenter,
                            colors: [
                        ...
                        : widget.variant == TactileButtonVariant.purple
                            ? const LinearGradient(
                                begin: Alignment.topCenter,
                                end: Alignment.bottomCenter,
                                colors: [
                  ...
                  : _isGhostVariant
                      ...
                      : widget.variant == TactileButtonVariant.gold
                          ...
                          : widget.variant == TactileButtonVariant.green
                              ...
                              : widget.variant == TactileButtonVariant.blue
                                  ? const Color(0xFF2D5A96).withValues(alpha: 0.60)
                                  : widget.variant == TactileButtonVariant.purple
                                      ? const Color(0xFF6040A0).withValues(alpha: 0.60)
