...
class PracticeDiceRow extends StatelessWidget {
  ...
  Widget _buildDieShell({required Widget child, bool selected = false, double mergeFlash = 0.0}) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isMergeAnimating
              ? accentColor.withValues(alpha: 0.84)
              : selected
              ? selectionColor.withValues(alpha: 0.85)
              : Colors.white.withValues(alpha: 0.18),
          width: isMergeAnimating
              ? 2.3
              : selected
              ? 2.4
              : 1.2,
        ),
        boxShadow: isMergeAnimating
            ? [
                BoxShadow(
                  color: accentColor.withValues(alpha: 0.34 * flashGlow),
                  blurRadius: 20,
                  spreadRadius: 1.6,
                ),
                BoxShadow(
                  color: accentColor.withValues(alpha: 0.24 * flashGlow),
                  blurRadius: 28,
                  spreadRadius: 1.0,
            ...
            ? [
                BoxShadow(
                  color: selectionColor.withValues(alpha: 0.60),
                  blurRadius: 10,
                  spreadRadius: 1.2,
                ),
                BoxShadow(
