  ...
  Widget _buildDailyContent() {
    ...
    return Column(
      ...
      children: [
        Center(
          child: Text(
            '2 runs · 2 minutes each · Same puzzles',
            style: TextStyle(
              fontSize: 13,
              color: Colors.white.withValues(alpha: 0.38),
              fontWeight: FontWeight.w500,
        ...
        Row(
          children: [
            Expanded(
              child: _DailyRunCard(label: 'Run 1', score: state.run1, card: _card, green: _green),
            ),
        ...
        if (state.allTimeBest > 0)
          Center(
            child: Text(
              'All-time best: ${state.allTimeBest}',
              style: TextStyle(
                fontSize: 14,
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: active ? green.withValues(alpha: 0.55) : Colors.transparent),
          ),
          child: Center(
            child: Text(
              label,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: played ? green.withValues(alpha: 0.40) : Colors.white.withValues(alpha: 0.07),
        ),
      ),
      child: Column(
        children: [
